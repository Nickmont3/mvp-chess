  ...
  if (typeof props.board === 'object') {
    props.board.forEach((square) => {
      ...
      if (square.piece === 'R') {
        ...
        componentList.push((<Rook piece={piece} coor={square.coor} />))
      } else if (square.piece === 'N') {
        piece = 'knight' + square.pieceColor;
        componentList.push((<Knight piece={piece} coor={square.coor} />))
      } else if (square.piece === 'B') {
        piece = 'bishop' + square.pieceColor;
        componentList.push((<Bishop piece={piece} coor={square.coor} />))
      } else if (square.piece === 'Q') {
        piece = 'queen' + square.pieceColor;
        componentList.push((<Queen piece={piece} coor={square.coor} />))
      } else if (square.piece === 'K') {
        piece = 'king' + square.pieceColor;
        componentList.push((<King piece={piece} coor={square.coor} />))
      } else if (square.piece === 'p') {
        piece = 'pawn' + square.pieceColor;
        componentList.push((<Pawn piece={piece} coor={square.coor} />))
      }
    })
  }
